...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ variant = 'secondary', size = 'md', fullWidth = false, className = '', children, as: Component = 'button', ...props }, ref) => {
    ...
    const variantClasses = {
      ...
      circular: `bg-white/80 dark:bg-neutral-800/80 ${styles.textColor} backdrop-blur-sm border border-neutral-200/50 dark:border-neutral-700/50 shadow-sm hover:bg-white/90 dark:hover:bg-neutral-800/90 font-medium`
    };
