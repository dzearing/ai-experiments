        ...
        `}>
          ...
          <div className="p-6">
            <div className="flex items-start gap-3 mb-4">
              <svg className="w-6 h-6 text-green-600 dark:text-green-400 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <div className={`bg-gray-100 dark:bg-gray-700/50 px-3 py-2 rounded-md ${styles.mutedText} text-sm font-mono`}>
              Feedback ID: {feedbackId}
            </div>
          </div>

          <div className={`flex items-center justify-end px-6 py-4 border-t ${styles.contentBorder}`}>
            <Button
              onClick={onClose}
              variant="primary"
            >
