...
<task type="checkpoint:human-verify" gate="blocking">
  <what-built>File browser and viewer components for workspace exploration</what-built>
  <how-to-verify>
1. Start the dev server: `pnpm dev:v2` (or `cd apps/claude-code-web && pnpm dev`)
2. Navigate to the app in browser
3. Note: The FileBrowser and FileViewer are created but may not be wired into the main UI yet
4. To verify the components work:
   - Import and render FileBrowser in a test location (e.g., temporarily in App.tsx)
