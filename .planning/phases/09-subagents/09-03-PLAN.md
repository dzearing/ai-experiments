...
must_haves:
  truths:
    - "Running subagents display a visual indicator in the chat UI"
    - "Subagent indicator shows agent type and elapsed time"
    - "Completed subagents transition from spinning to checkmark state"
  artifacts:
