...
// Generated from: src/svgs/actions/add-circle.svg
// To update this icon, modify the SVG file and run: pnpm generate-icons
const svgContent = `<circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
...
export const AddCircleIcon = createIcon(svgContent, 'AddCircleIcon');
