      ...
      <Panel padding="lg">
        ...
        <Stack direction="row" gap="lg" align="start">
          ...
          <Stack gap="sm" style={{ flex: 1 }}>
            ...
            <Text size="sm" color="softer">San Francisco, CA</Text>

            <Stack direction="row" gap="md" style={{ marginTop: '0.5rem' }}>
        ...
        <Stack gap="sm">
          ...
          <Text size="xs" color="softer">Add a bio to complete your profile</Text>
        </Stack>
      </Panel>
                ...
                <Stack gap="md">
                  <Stack direction="row" gap="md" align="start">
                    ...
                    <Stack gap="xs">
                      ...
                      <Stack direction="row" gap="sm" align="center">
                        ...
                        <Text size="xs" color="softer">2020 - Present</Text>
                      </Stack>
                    </Stack>
                  </Stack>
                  ...
                  <Stack direction="row" gap="md" align="start">
                    ...
                    <Stack gap="xs">
                      ...
                      <Text size="xs" color="softer">2017 - 2020</Text>
                    </Stack>
                  </Stack>
                </Stack>
              </Stack>
            ...
            <Stack gap="lg">
              ...
              <Stack gap="md">
                {[
                  ...
                  <Stack key={connection.name} direction="row" gap="md" align="center" justify="between">
                    <Stack direction="row" gap="md" align="center">
                      ...
                      <Stack gap="xs">
                        ...
                        <Text size="xs" color="softer">{connection.mutual} mutual connections</Text>
                      </Stack>
                    </Stack>
