 ...
 * - **Icons**: UserIcon, CommentIcon, SendIcon, GearIcon, WarningIcon, BellIcon
 */
...
function NotificationCenterPage() {
  ...
  const getNotificationIcon = (type: string) => {
    ...
    switch (type) {
      case 'mention': return <UserIcon style={iconStyle} />;
      case 'comment': return <CommentIcon style={iconStyle} />;
      case 'invite': return <SendIcon style={iconStyle} />;
      case 'system': return <GearIcon style={iconStyle} />;
      case 'alert': return <WarningIcon style={iconStyle} />;
      default: return <BellIcon style={iconStyle} />;
    }
  };
    ...
    <div style={{ minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '2rem' }}>
        ...
        <Panel padding="md" style={{ marginTop: '1.5rem', background: 'var(--inset-bg)' }}>
          ...
          <Stack direction="horizontal" gap="sm" wrap style={{ marginTop: '0.5rem' }}>
        ...
        {/* Filter Chips */}
        <Stack direction="horizontal" gap="sm" wrap style={{ marginTop: '1.5rem' }}>
          <Chip
              ...
              {filteredNotifications.map((notification, index) => (
                <div key={notification.id}>
                  ...
                  <div
                    style={{
                      padding: 'var(--space-4)',
                      background: notification.read ? 'transparent' : 'var(--inset-bg)',
                      cursor: 'pointer',
                    }}
                  ...
                  >
                    <Stack direction="horizontal" gap="md" align="start">
                      {notification.avatar ? (
                        <Avatar size="md" fallback={notification.avatar} color="#6366f1" />
                      ) : (
                        <div style={{
                          width: 40,
                          height: 40,
                          borderRadius: 'var(--radius-full)',
                          background: 'var(--controlSubtle-bg)',
                          color: 'var(--body-text)',
                          display: 'flex',
                          alignItems: 'center',
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        <Stack direction="horizontal" justify="between" align="start">
                          <div style={{ flex: 1 }}>
                            ...
                            <Stack direction="horizontal" align="center" gap="md" style={{ marginTop: '0.5rem' }}>
                              <Text size="xs" color="soft">{notification.time}</Text>
                              {notification.action && (
                          ...
                          <Button
                            ...
                            size="sm"
                            shape="square"
                            icon={<CloseIcon style={{ width: 16, height: 16 }} />}
...
- Wrap chips in a Stack with \`horizontal\` and \`wrap\`
