      ...
      <Grid columns={4} gap="md" style={{ marginTop: '2rem' }}>
        {metrics.map((metric) => (
          <Panel key={metric.label} padding="lg">
            ...
            <Stack direction="horizontal" align="end" gap="sm" style={{ marginTop: '0.5rem' }}>
              <Text size="xl" weight="bold">{metric.value}</Text>
              {metric.change !== '0' && (
                <Text
                  size="sm"
                  style={{
                ...
                >
                  <Stack direction="horizontal" justify="between" align="start">
                    <div style={{ flex: 1 }}>
                      ...
                      <Stack direction="horizontal" align="center" gap="md" style={{ marginTop: '0.75rem' }}>
                      ...
                      <Stack direction="horizontal" align="center" gap="md" style={{ marginTop: '0.75rem' }}>
                        <div style={{ display: 'flex' }}>
                          {project.team.slice(0, 3).map((member, i) => (
                            <span key={i} style={{ marginLeft: i > 0 ? '-8px' : 0 }}>
                              <Avatar
                                size="sm"
                                fallback={member}
                              />
                        ...
                        <Text size="xs" color="soft">Due {project.dueDate}</Text>
                      </Stack>
                    </div>
          ...
          <Panel padding="lg">
            ...
            <Stack gap="md">
              {recentActivity.map((activity, index) => (
                <Stack key={index} direction="horizontal" gap="sm" align="start">
      ...
      <Panel padding="lg" style={{ marginTop: '2rem' }}>
        ...
        <Grid columns={4} gap="md">
          {[
            ...
            <Stack key={member.name} direction="horizontal" gap="md" align="center">
...
- Display the metric value prominently with \`size="xl" weight="bold"\`
...
- Show relative timestamps in \`color="soft"\`
