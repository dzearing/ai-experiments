...
const lessons = [
  {
    ...
    description: 'Installation, first use, and the bootstrap script for zero-flash loading.',
  ...
  },
  {
    ...
    description: 'The core concept: surfaces provide semantic contexts for your UI elements.',
    path: '/learn/surfaces',
    duration: '10 min',
  },
  {
  ...
  },
  {
    ...
    description: 'Custom surfaces, performance optimization, and accessibility best practices.',
    path: '/learn/advanced',
    duration: '10 min',
  },
];
