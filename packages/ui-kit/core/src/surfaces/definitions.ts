 ...
 * - Tonal surface types (base, raised, sunken, soft, softer, strong, stronger, inverted, primary)
 * - Feedback surface types (success, warning, danger, info)
 * - Helper functions for working with surfaces
 */
