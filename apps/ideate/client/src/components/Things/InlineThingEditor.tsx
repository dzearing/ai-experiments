...
import styles from './InlineThingEditor.module.css';

export interface PendingThing {
  /** Temporary ID for tracking */
  tempId: string;
  /** Thing name being edited */
  name: string;
...
interface InlineThingEditorProps {
  /** The pending thing being edited */
  item: PendingThing;
...
export function InlineThingEditor({
  item,
  isFocused,
  onChange,
  onCommit,
