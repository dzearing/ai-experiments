...
export interface ThingDocumentsProps {
  /** The Thing ID to show documents for */
  thingId: string;
}

export function ThingDocuments({ thingId }: ThingDocumentsProps) {
  ...
  // Fetch documents for this Thing on mount and when thingId changes
  useEffect(() => {
  ...
  }, [selectedDocument, renameTitle, updateDocument, closeRenameModal, fetchDocuments, thingId]);
