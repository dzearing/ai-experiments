...
import styles from './ThingProperties.module.css';

export interface ThingPropertiesRef {
  startAdd: () => void;
}
...
export const ThingProperties = forwardRef<ThingPropertiesRef, ThingPropertiesProps>(
  function ThingProperties({ properties, onChange, disabled }, ref) {
