                  ...
                  {personas.length === 0 ? (
                    <tr>
                      <td colSpan={6} className="px-3 py-4 text-sm text-gray-500 text-center">
                        ...
                        <Link to="/personas/new" className="text-indigo-600 hover:text-indigo-500">
                      ...
                      return (
                        <tr key={persona.id}>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
                            <span
                              className={`inline-flex rounded-full px-2 text-xs font-semibold leading-5 ${personaTypeColors[persona.type]}`}
                            >
