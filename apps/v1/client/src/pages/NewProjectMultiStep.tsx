  ...
  const handleGitHubImport = async () => {
    ...
    try {
      ...
      const detailsResponse = await fetch(
        'http://localhost:3000/api/workspace/extract-repo-details',
        {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className={`text-lg font-semibold ${styles.headingColor} mb-2`}>
                    Create new project
                  </h3>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className={`mt-1 text-sm ${styles.mutedText}`}>
                    The repository will be cloned and project details will be extracted from
