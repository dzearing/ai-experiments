    ...
    (index: number) => {
      ...
      if (group.type === 'toolGroup') {
        ...
        const estimatedHeight =
          baseHeight + contentLines * lineHeight + codeBlockCount * codeBlockHeight;
        ...
        return (
          ...
          >
            {group.type === 'toolGroup' ? (
              <ToolExecutionGroup tools={group.messages} sessionId={sessionId} />
            ) : (
              <ClaudeMessage
                ...
                isLatestAssistantMessage={
                  ...
                  messages.findLastIndex(
                    (m) => m.role === 'assistant' && m.id === group.messages[0].id
                  ) ===
                    messages.length - 1
                }
                sessionId={sessionId}
