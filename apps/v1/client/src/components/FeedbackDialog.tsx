...
export function FeedbackDialog({
  ...
  const handleSubmit = async () => {
    ...
    try {
      await onSubmit(
        expectedBehavior.trim() || 'Not specified',
        actualBehavior.trim() || feedback.trim()
      );
  ...
  const dialogContent = (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div ref={dragRef} className="relative p-4 w-full max-w-2xl" style={dragStyle}>
        <div
          className={`
        ...
        >
          ...
          <div className="p-6 overflow-y-auto flex-1">
            ...
            <div className="space-y-4">
              ...
              <div
                className={`flex items-center gap-2 text-sm ${styles.mutedText} bg-blue-50 dark:bg-blue-900/20 p-3 rounded-md`}
              >
                <svg
          ...
          <div
            className={`flex items-center justify-end gap-3 px-6 py-4 border-t ${styles.contentBorder} flex-shrink-0`}
          >
